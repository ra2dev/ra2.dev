...
export default function Footer() {
    return (
        <footer className='flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8 mt-10'>
            ...
            <div className='w-full max-w-2xl grid grid-cols-1 gap-4 pb-16 sm:grid-cols-3'>
                ...
                <div className='flex flex-col space-y-4'>
                    <ExternalLink href='https://twitter.com/ratwodev'>Twitter</ExternalLink>
                    <ExternalLink href='https://github.com/ra2dev'>GitHub</ExternalLink>
                </div>
                <div className='flex flex-col space-y-4'>
                    <Link href='/uses'>
